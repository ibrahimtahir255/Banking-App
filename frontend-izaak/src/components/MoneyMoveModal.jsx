...
export default function MoneyMoveModal({ direction, account, onClose, onSuccess }) {
  ...
  function goToConfirm(e) {
    ...
    setError('');
    if (isFrozen) {
      setError('This account is frozen. Enter the verification code in the risk panel before making any moves.');
      return;
    }
    if (parsedAmount <= 0) {
          ...
          <>
            ...
            <form onSubmit={goToConfirm} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              {isFrozen && (
                ...
                >
                  This account is frozen. Enter the verification code in the risk panel before making any moves.
                </div>
              )}
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
                ...
                <button type="submit" className="btn btn-primary" disabled={isFrozen}>
                  Next
                </button>
              </div>
            </form>
        ...
        {step === 'confirm' && (
          <>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              <button className="btn btn-primary" disabled={submitting || isFrozen} onClick={handleConfirm}>
